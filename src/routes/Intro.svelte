...
<main>
    <h1>Skaly Demo Dashboard</h1>
    <p>
        The demo dashboard allows you to connect to the Skaly app through IOTA and Freighter's FRPC technology.
        Please keep in mind that the demo dashboard is a heavily stripped down version of the actual Skaly dashboard and the official dashboard offers a broad range of features such as instant prediction or user's weight, identifying groups (positive or negative) development and anti cheat protection.
    </p>
